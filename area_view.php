			...
			<div class="min-height-200px">
				<div class="page-header">
					<div class="row">
						...
						<div class="col-md-2 col-sm-2" align="right">
							<a href="area_add.php"><button class="btn btn-primary">Add Area</button></a>
						</div>
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<!-- <h5 class="text-blue">View Area</h5> -->
						</div>
					</div>
					<div class="row">
						...
						<table class="stripe hover data-table-export nowrap">
							...
							<tbody>
								...
								<tr>
									...
									<td><a href="#" data-toggle="modal" data-target="#area_update<?php echo $fetch['fld_area_id'] ?>"  title="Edit Area"><i class="fa fa-pencil-square-o text-success" style="font-size: 20px" ></i> </a>

									<a href="area_delete.php?fld_area_id=<?php echo $fetch['fld_area_id'] ?>" onclick="return confirm('Do You Want To Delete Area?.')" title="Delete Area" ><i class="fa fa-trash text-danger" style="font-size: 20px; padding-left: 10px" ></i></a>
									</td>
									...
									<td><?php echo $fetch['fld_area_created_date'];?></td>
									<td><?php echo $fetch['fld_area_modified_date'];?></td>

									<div class="modal fade bs-example-modal-lg" id="area_update<?php echo $fetch['fld_area_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
										<div class="modal-dialog modal-lg modal-dialog-centered">
											<div class="modal-content">
												<div class="modal-header">
													<h4 class="modal-title" id="myLargeModalLabel">Update Area</h4>
													<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
												</div>

												<?php 

													$abc=mysqli_query($connect,"select * from tbl_area where fld_area_delete='0' and fld_area_id='".$fetch['fld_area_id']."'") or die(mysqli_error($connect));
													$view=mysqli_fetch_array($abc);
												?>
												<form method="post" action="area_update.php?fld_area_id=<?php echo $fetch['fld_area_id'] ?>">
							...
							<select class="form-control custom-select" name="state" id="state<?php echo $count; ?>" required="" style="width: 100%">
								...
								<?php } ?>
														...
														<div class="form-group row">
															...
															<div class="col-sm-12 col-md-9">
																<input class="form-control" type="text" name="area" id="area1" placeholder="Enter Area Name" required="" value="<?php echo $view['fld_area_name'] ?>" oninput="this.value = this.value.replace(/[^A-Za-z\s]/g, '').replace(/(\..*)\./g, '$1');" style="text-transform: capitalize;">
															</div>
														</div>
													</div>
