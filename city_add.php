            ...
            <div class="col-md-10 col-sm-10">
              ...
              <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="city_view.php">City/Village</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Add City/Village</li>
                </ol>
              </nav>
            </div>
						<div class="col-md-2 col-sm-2" align="right">
              <!-- <a  href="#" data-toggle="modal" data-target="#bill_head_add" type="button"><button  class="btn btn-primary">Add City</button></a> -->
              <a  href="city_view.php" ><button  class="btn btn-primary">View City/Village</button></a>
            </div>
					</div>
				</div>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                ...
                {                    
                    ...
                    $total_city = count($_POST['fld_city_name']);

                    for($i=0;$i<$total_city;$i++)
                    {
                      if(($_POST['fld_city_name'][$i]!=""))
                      {

                        $nm=mysqli_query($connect,"select * from tbl_city where fld_country_id='".$_POST['country']."' and fld_state_id='".$_POST['state']."' and fld_district_id='".$_POST['district']."' and fld_taluka_id='".$_POST['taluka']."' and fld_city_name = '".$_POST['fld_city_name'][$i]."' and fld_city_delete='0' ");
                        if(mysqli_num_rows($nm)>0)
                        {
                            echo "<script>";
                            echo "alert('City Is Already Exists');";
                        ...
                        else
                        {
                          ...
                          $city1=$_POST['fld_city_name'][$i];
                          $city=ucwords(strtolower($city1));
                          $query = "INSERT INTO tbl_city(fld_country_id, fld_state_id, fld_district_id, fld_taluka_id, fld_city_name,fld_city_delete) VALUES ('".$_POST['country']."','".$_POST['state']."','".$_POST['district']."','".$_POST['taluka']."','".$city."','0')" ;
                          ...
                          if(!empty($result)) 
                              ...
                              {
                                  echo "<script>";
                                   echo "alert('City Not Added Successfully');";
                                  echo "window.location.href='city_view.php';";
                                  echo "</script>";
                              }
                        }
            ...
            <div class="form-group row">              
              <div class="col-sm-12 col-md-12">
                <!-- <input class="form-control" type="text" name="bill_head" id="bill_head" placeholder="Enter City " required=""  oninput="this.value = this.value.replace(/[^A-Za-z\s]/g, '').replace(/(\..*)\./g, '$1');" > -->
                <table  class="table table-hover small-text" id="tb">
                  ...
                  <tr>
                    ...
                    <td><input type="text" name="fld_city_name[]" id="fld_city_name" placeholder="Enter City" class="form-control" required="" oninput="this.value = this.value.replace(/[^A-Za-z\s]/g, '').replace(/(\..*)\./g, '$1');" style="text-transform: capitalize;"></td>
                    </tr>                    
                  </table>
              </div>
            </div>
...
<!-- 							<label class="col-sm-12 col-md-3 col-form-label">Submit</label>
 -->							<div class="col-sm-12 col-md-9">
							<center><input class="btn btn-success" value="Submit" type="submit" name="submit">
								...
								<a href="city_view.php"><input class="btn btn-warning" value="Back" type="button"></a>
							</center>
							</div>
						</div>
					</form>
