				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-9 col-sm-9">
							<div class="title">
								<h4> Approve Vendor Business</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
									<li class="breadcrumb-item active" aria-current="page">Approve Vendor Business</li>
								</ol>
							</nav>
						</div>
					</div>
...
$asd = "select v.*, bi.*, bt.*, bc.*, bsc.* from vendor v, business_information bi, tbl_business_type bt, tbl_business_subcategory bsc, tbl_business_category bc where bi.business_status ='Approved' and bi.fld_business_id=bt.fld_business_id and bc.fld_business_category_id =bi.fld_business_category_id and bsc.fld_business_subcategory_id=bi.fld_business_subcategory_id and bi.vendor_id=v.vendor_id order by bi.business_info_id desc";
			                ...
			                ?>
			                 	<tr>
			                 		...
			                 		<td>
			                 			...
			                 			<a href="delete_business_information.php?business_info_id=<?php echo $fetch['business_info_id']; ?>" class="text-danger" onclick="return confirm ('Are You Sure You Wannt to Delete this record...?');"  title="Delete Business Information"><i class="fa fa-trash" aria-hidden="true" style="font-size: 20px"></i></a>&nbsp;&nbsp; 
			                 		...
			                 		<td><a href="payment_details.php?business_id=<?php echo $fetch['business_info_id']; ?>" class="text-primary"   title="Payment Details"><i class="fa fa-list-ul" aria-hidden="true" style="font-size: 20px"></i></a>&nbsp;&nbsp;  </td>
