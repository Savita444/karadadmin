		...
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
            ...
            <div class="form-group row">
              ...
              <label class="col-form-label">Package Name <span class="text-danger">*</span> : </label>
                  <input class="form-control" type="text" name="fld_package_name" id="package" placeholder="Enter Package Name"  required="">
                </div>
            </div>
              <div class="form-group row">
                <div class="col-md-6">
           ...
           <div class="form-group row">
            ...
            <div class="form-group row"> -->
             ...
             <div class="form-group row">
              <div class="col-md-6">
              <label class="col-form-label">GST Type <span class="text-danger">*</span> : </label>
                <select name="fld_taxtype_id" class="form-control custom-select2" id="gst_type" required="">
                  <option value="">Select Gst Type</option> 
                  <?php
                    $cont=mysqli_query($connect,"select * from tbl_tax_type where fld_tax_delete ='0' order by fld_taxtype_id desc") or die(mysqli_error($connect));
                    while ($fetch_business_type1=mysqli_fetch_array($cont)) {
                  ?>
                  <option value="<?php echo $fetch_business_type1['fld_taxtype_id']; ?>" ><?php echo $fetch_business_type1['fld_tax_type']; ?></option>
                  <?php } ?>
                </select>
              </div>
              <div class="col-md-6">
              <label class="col-form-label">GST<span class="text-danger">*</span> : </label>
                <select name="fld_tax_id" class="form-control custom-select2" id="fld_tax" required="">
                  <option value="">Select GST</option> 
                  <?php
                    $cont=mysqli_query($connect,"select * from tbl_tax where fld_tax_delete ='0' order by fld_tax_id desc") or die(mysqli_error($connect));
                    while ($fetch_business_type1=mysqli_fetch_array($cont)) {
                  ?>
                  <option value="<?php echo $fetch_business_type1['fld_tax_id']; ?>" ><?php echo $fetch_business_type1['fld_tax']; ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
 ...
 if (isset($_POST['submit'])) 
        {
            ...
            extract($_POST);
               echo $query="INSERT INTO tbl_packages(fld_product_type_id,fld_package_name,fld_business_id,fld_business_category_id,fld_package_amount,fld_number_of_request_leads_id,fld_validity_in_days_number,fld_tax_id,fld_taxtype_id) VALUES ('$fld_product_type_id','$fld_package_name','$fld_business_id','$fld_business_category_id','$fld_package_amount','$fld_number_of_request_leads_id','$fld_validity_in_days_number','$fld_tax_id','$fld_taxtype_id')";
