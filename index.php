			...
			<form method="post">
				...
				<div class="row">
					...
					<div class="col-sm-5 pl-4">
                        <img src="captcha.php" id="captchaId" alt="PHP Captcha" >
                    </div>
                    <div class="col-sm-2 pl-2">
                    	<span  id="reload" value="Reload" class="btn btn-sm btn-info " ><i class="fa fa-refresh" style="font-size:24px"></i></span>
                    </div>
				</div>
				</div>
...
<script type="text/javascript">
    $(function() { // Handler for .ready() called.
            $('#reload').click(function(){
                $('#captchaId').attr('src', 'captcha.php?' + (new Date).getTime());
            });
        });
    </script>
<?php
