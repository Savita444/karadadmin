...
<html>
<head>
	<title> View package <?php echo date('d-m-Y'); ?> </title>
...
// $query1="select pt.*,b.*,bc.*,p.* from tbl_product_type pt,tbl_business_type b, tbl_business_category bc, tbl_packages p where pt.`fld_product_type_id`=p.`fld_product_type_id` and b.`fld_business_id`=bc.`fld_business_id` and bc.fld_business_category_id=p.`fld_business_category_id` and b.fld_business_id=p.fld_business_id and p.fld_package_delete='0' group by p.fld_package_id  order by p.fld_package_id desc";

$query1="select pt.*,b.*,bc.*,p.*,g.*,t.* from tbl_product_type pt,tbl_business_type b, tbl_business_category bc, tbl_packages p, tbl_tax g, tbl_tax_type t where pt.`fld_product_type_id`=p.`fld_product_type_id` and b.`fld_business_id`=bc.`fld_business_id` and bc.fld_business_category_id=p.`fld_business_category_id` and b.fld_business_id=p.fld_business_id and g.fld_tax_id=p.fld_tax_id and t.fld_taxtype_id=p.fld_taxtype_id and p.fld_package_delete='0' group by p.fld_package_id  order by p.fld_package_id desc";
								...
								<tr>
									...
									<td>
										...
										<a href="package_delete.php?package_id=<?php echo $fetch['fld_package_id'] ?>" onclick="return confirm('You are sure to delete the Package.')" title="Delete Package" ><i class="fa fa-trash text-danger" style="font-size: 20px; padding-left: 10px" ></i></a>
									</td>
