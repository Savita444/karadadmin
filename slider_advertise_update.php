    ...
    <div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
      <div class="min-height-200px">
        <div class="page-header">
          <div class="row">
            <div class="col-md-6 col-sm-12">
              <div class="title">
                <h4>Update Slider Advertise</h4>
              </div>
              <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <!-- <li class="breadcrumb-item"><a href="slider_advertise_view.php">Slider Advertise</a></li> -->
                  <li class="breadcrumb-item active" aria-current="page">Update Slider Advertise</li>
                </ol>
              </nav>
            </div>
        ...
        <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
          ...
          <br>
<?php 
  $abc=mysqli_query($connect,"select * from slider_advertise_image where slider_advertise_id='".$_GET['slider_advertise_id']."'") or die(mysqli_error($connect));
          ...
          <form method="post" enctype="multipart/form-data">
              ...
              <div class="col-sm-12 col-md-10">
                 <div class="preview_box">
                    <?php
                        ...
                        {
                    ?>
                            <img src="../images/admin/slider/No-image-full.jpg" alt="" id="preview_img" height="100px" width="100px"/>
                    <?php
                        }
                        else
                        {
                    ?>                                        
                            <img src="../images/admin/slider/<?php echo $view['image'];?>" alt="" id="preview_img" height="100px" width="100px" />
                    <?php
                        }
                    ?>
                    <input type="file" name="photo" id="image1"  />
                </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-12 col-md-4">
                <input class="form-control" type="date" placeholder="Enter Title" name="start_slider_date" value="<?php echo $view['start_slider_date']?>" required="">
              </div>

                <label class="col-sm-12 col-md-2 col-form-label">End Date<span style="color: red;">*</span> : </label>
              <div class="col-sm-12 col-md-4">
                <input class="form-control" type="date" placeholder="Enter Title" name="end_slider_date" value="<?php echo $view['end_slider_date']?>" required="">
              </div>
            </div>
        ...
        extract($_POST);
           ...
           // upload Photo
            ...
            move_uploaded_file($temp,$upload.$photo);
              ...
              $update=mysqli_query($connect,"update slider_advertise_image set
                title ='".$title."',
                ...
                fld_city_id ='".$city."'
                where slider_advertise_id='".$_GET['slider_advertise_id']."'") or die(mysqli_error($connect));
            ...
            if($update)
            {
               ...
               echo " alert('Slider Advertise Image Update Successfully.');";
           ...
           {
               echo '<script type="text/javascript">';
               echo " alert('Slider Advertise Image Not Update.');";
               echo 'window.location.href = "slider_advertise_view.php";';
               echo '<script>';
            }
    }
