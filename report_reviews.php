...
<html>
<head>
    <title> Reviews Report <?php echo date('d-m-Y'); ?> </title>
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item" ria-current="page">Reviews Details</li>
...
if(isset($_POST['submit']))
	{
		extract($_POST);
          ...
          $conditions=array();
           ...
           $query="select bi.*, bt.*,s.*,d.*,c.*,br.* from business_information bi, tbl_business_type bt,tbl_state s, tbl_district d,tbl_city c,tbl_business_review br where bi.business_info_id=br.business_info_id and br.fld_business_id=bt.fld_business_id and bi.fld_state_id=s.fld_state_id and bi.fld_district_id=d.fld_district_id and  bi.fld_city_id=c.fld_city_id  ";
		...
		{
			$query .=" and br.fld_business_id='".$_POST['business_type']."'";
		}
		 if((isset($_POST['business_info'])) && ($_POST['business_info']!="") )
    {
      $query .=" and bi.business_info_id='".$_POST['business_info']."'";
        ...
        if(!empty($fromDate) && !empty($endDate)){
             $query .= " and br.review_date
                          between '".$fromDate."' and '".$endDate."' ";
          }
          $query.='group by br.fld_business_review_id order by br.fld_business_review_id desc';
	// echo $query; exit();	
	}
 ...
 <div class="row">
                  ...
                  <!--         <a href="feature_advertise_delete.php?feature_image_id=<?php //echo $fetch['feature_image_id'] ?>" onclick="return confirm('You are sure to delete the Feature Advertise.')" title="Delete Feature Advertise" ><i class="fa fa-trash text-danger" style="font-size: 20px; padding-left: 10px" ></i></a></td>-->
									 <td><?php echo $fetch['fld_business_name'];?></td> 
                                                ...
                                                <td><?php echo $fetch['review_star'] ?></td> 
                                                <td><?php echo $fetch['review_text'] ?></td> 
                                              <td><?php echo $fetch['review_date'];?></td>
                                                 <td><?php echo $fetch['review_time'] ?></td> 
                                                <td><?php echo $fetch['freview_from'] ?></td>
