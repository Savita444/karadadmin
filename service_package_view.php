				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-10 col-sm-10">
							<div class="title">
								<h4>Service Packages Details</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
									<li class="breadcrumb-item active" aria-current="page">Service Packages Details</li>
								</ol>
							</nav>
						</div>
						...
						<div class="col-md-2 col-sm-2">
							...
							<a class="btn btn-primary" href="service_package_add.php" role="button">
									Add Service <br>Packages
							</a>
						</div>
						...
						<table class="stripe hover data-table-export nowrap">
							<thead>
								<tr>
                                    ...
                                    <th>Cost</th>
                                    <th>Multiple<br> Cost of<br> Benefit</th>
                                    <th>Free <br>Order <br>Per Day</th>
                                    <!-- <th>Free order amount per day</th> -->
                                    <th>Free Order Amount Per Month</th>
                                    <th>Percentage of Commission after free order</th>
                                    <!-- <th>Free appointment per day Appointment</th>
                                    <th>Free appointment per month Appointment</th> -->
                                    <th>Date</th>
								</tr>
							</thead>
							<tbody>
								<?php 
                                    $count=0; 
                                    $query1="select *  from packages where business_type='Services'order by package_id desc";
								...
								<tr>
									...
									<td>
										...
										<a href="service_package_update.php?package_id=<?php echo $fetch['package_id'] ?>" title="Edit Package" ><i class="fa fa-pencil-square-o text-success" style="font-size: 20px; padding-left: 10px" ></i></a>

										<a href="package_delete.php?package_id=<?php echo $fetch['package_id'] ?>" onclick="return confirm('You are sure to delete the Package.')" title="Delete Package" ><i class="fa fa-trash text-danger" style="font-size: 20px; padding-left: 10px" ></i></a>
									</td>
									...
									<td><?php echo $fetch['free_order_per_day'];?></td>
									<!-- <td><?php //echo $fetch['free_order_amount_per_day'];?></td> -->
									<td><?php echo $fetch['free_order_amount_per_month'];?></td>
									<td><?php echo $fetch['percentage_of_commission_after_free_order'];?></td>
