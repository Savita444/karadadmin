...
<html>
<head>
    <title> Business Details Report <?php echo date('d-m-Y'); ?> </title>
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item" ria-current="page">Business Details</li>
...
if(isset($_POST['submit']))
	{
		extract($_POST);
          ...
          // $value = $_POST['business_info_id'];
          $conditions=array();

           $query="select v.*, bi.*, bt.*, bc.*, bsc.*,s.*,d.*,c.* from vendor v, business_information bi, tbl_business_type bt,tbl_business_category bc, tbl_business_subcategory bsc, tbl_state s, tbl_district d,tbl_city c where bi.vendor_id=v.vendor_id and bi.fld_business_id=bt.fld_business_id and bc.fld_business_category_id =bi.fld_business_category_id and bsc.fld_business_subcategory_id=bi.fld_business_subcategory_id and bi.fld_state_id=s.fld_state_id and bi.fld_district_id=d.fld_district_id and  bi.fld_city_id=c.fld_city_id";
    ...
    $row=mysqli_query($connect,$query) or die(mysqli_error($connect));
      ...
      $cond .=" and bi.fld_business_id='".$_POST['business_type']."'";
		...
		// }
          ...
          if((isset($_POST['business_status'])) && ($_POST['business_status']!="") )
		{
			$query .=" and bi.business_info_id IN (SELECT business_info_id FROM business_information where bi.business_status='".$_POST['business_status']."')";
       $cond .=" and bi.business_info_id IN (SELECT business_info_id FROM business_information where bi.business_status='".$_POST['business_status']."')";
		}

            if(!empty($fromDate) && !empty($endDate)){
             $query .= " and bi.created_at 
                          between '".$fromDate."' and '".$endDate."' ";
            $cond  .= " and bi.created_at 
                          between '".$fromDate."' and '".$endDate."' ";
          }
          $query.=' group by bi.business_info_id order by bi.business_info_id desc';
         $cond.=' group by bi.business_info_id order by bi.business_info_id desc';
    ...
    {
    	 $query="select v.*, bi.*, bt.*, bc.*, bsc.*,s.*,d.*,c.* from vendor v, business_information bi, tbl_business_type bt,tbl_business_category bc, tbl_business_subcategory bsc, tbl_state s, tbl_district d,tbl_city c where bi.vendor_id=v.vendor_id and bi.fld_business_id=bt.fld_business_id and bc.fld_business_category_id =bi.fld_business_category_id and bsc.fld_business_subcategory_id=bi.fld_business_subcategory_id and bi.fld_state_id=s.fld_state_id and bi.fld_district_id=d.fld_district_id and  bi.fld_city_id=c.fld_city_id group by bi.business_info_id";
     }
     // echo $query; exit();
          $row=mysqli_query($connect,$query)or die(mysqli_error($connect));
 ?>
 ...
 <form method="post" enctype="multipart/form-data">
	...
	<div class="col-sm-6 col-md-6">
		...
		<div class="col-sm-6 col-md-6">
			<div class="form-group">
				...
				<select name="business_status" class="form-control custom-select2" id="business_status" >
                  	<option value="">Select Business Status </option>                  	

                  	
                  <?php if(isset($_POST['submit'])){ ?>
                  		<option value="NotApproved" <?php if($_POST['business_status']=="NotApproved") { echo "selected"; } ?>>NotApproved</option>
                  			<option value="Approved" <?php if($_POST['business_status']=="Approved") { echo "selected"; } ?>>Approved</option>
                  	<option value="Disapproved" <?php if($_POST['business_status']=="Disapproved") { echo "selected"; } ?>>Disapproved</option>
  ...
  <tbody>
    <tr>
       ...
       // echo "select * from business_information where fld_business_delete='0' and business_status='Approved' $cond ";

       $q_approve = mysqli_query($connect,"select bi.*, v.* from business_information bi, vendor v where bi.vendor_id=v.vendor_id and bi.fld_business_delete='0' and bi.business_status='Approved' $cond");
      ...
      <td>
        <?php   
         $q_notapprove= mysqli_query($connect,"select bi.*, v.* from business_information bi, vendor v where bi.vendor_id=v.vendor_id and bi.fld_business_delete='0' and bi.business_status='NotApproved' $cond");
               $r = mysqli_num_rows($q_notapprove);
               echo "<span style='color:#5caceb;'>".'NotApproved:' . $r . "</span>";
               ?></td> 
     <td>
        <?php 
             $q_disapprove = mysqli_query($connect,"select bi.*, v.* from business_information bi, vendor v where bi.vendor_id=v.vendor_id and bi.fld_business_delete='0' and bi.business_status='Disapproved' $cond");
 ...
 <div class="row">
						...
						<table class="stripe hover data-table-export nowrap" width="100%">
							<thead>
								<tr>
									 ...
									 <td><?php echo $fetch['company_name'];?></td> 
                                                ...
                                                <td>
												     ...
												     <p class="d-flex">
													     ...
													     <a href="../images/vendor/Business_Photo/<?php echo $fetch['business_image']; ?>" Download height="50" width="50"><button type="button" name="download" class="btn btn-primary btn-sm  mt-1 align-center"><i class="fa fa-download" aria-hidden="true"></i></button></a>                               	
													    </a>
													   </span>
													  <img src="../images/vendor/Business_Photo/<?php echo $fetch['business_image'];?>" alt="photo" style="width: 50px !important; height:50px !important;">
												    </p>
													<figure>
													  <img src="../images/vendor/Business_Photo/<?php echo $fetch['business_image'];?>"  alt="photo">
													</figure>
												  </div> 
