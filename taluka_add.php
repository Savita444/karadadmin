            ...
            <div class="col-md-10 col-sm-10">
              ...
              <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="taluka_view.php">Taluka</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Add taluka</li>
                </ol>
              </nav>
            </div>
            <div class="col-md-2 col-sm-2" align="right">
              <!-- <a  href="#" data-toggle="modal" data-target="#bill_head_add" type="button"><button  class="btn btn-primary">Add taluka</button></a> -->
              <a  href="taluka_view.php" ><button  class="btn btn-primary">View Taluka</button></a>
            </div>
          </div>
        </div>
            ...
            <div class="pull-left">
              ...
              <?php
                ...
                {                    
                    ...
                    $total_taluka = count($_POST['fld_taluka_name']);

                    for($i=0;$i<$total_taluka;$i++)
                    {
                      if(($_POST['fld_taluka_name'][$i]!=""))
                      {

                        $nm=mysqli_query($connect,"select * from tbl_taluka where fld_country_id='".$_POST['country']."' and fld_state_id='".$_POST['state']."' and fld_district_id='".$_POST['district']."' and  fld_taluka_name = '".$_POST['fld_taluka_name'][$i]."' and fld_taluka_delete='0' ");
                        if(mysqli_num_rows($nm)>0)
                        {
                            echo "<script>";
                            echo "alert('taluka Is Already Exists');";
                            echo "window.location.href='taluka_view.php';";
                            echo "</script>";
                        }                     
                        else
                        {
                          $taluka1=$_POST['fld_taluka_name'][$i];
                          $taluka=ucwords(strtolower($taluka1));

                          $query = "INSERT INTO tbl_taluka(fld_country_id,fld_state_id,fld_district_id, fld_taluka_name,fld_taluka_delete) VALUES ('".$_POST['country']."','".$_POST['state']."','".$_POST['district']."','".$taluka."','0')" ;
                          ...
                          if(!empty($result)) 
                              ...
                              {
                                  echo "<script>";
                                  // echo "alert('taluka Added Successfully');";
                                  echo "window.location.href='taluka_view.php';";
                                  echo "</script>";                 
                              }
                              else
                              {
                                  echo "<script>";
                                   echo "alert('Taluka Not Added Successfully');";
                                  echo "window.location.href='taluka_view.php';";
                                  echo "</script>";
                              }
                        }
          ...
          <form method="post">
            ...
            <div class="form-group row">              
              <div class="col-sm-12 col-md-12">
                <!-- <input class="form-control" type="text" name="bill_head" id="bill_head" placeholder="Enter taluka " required=""  oninput="this.value = this.value.replace(/[^A-Za-z\s]/g, '').replace(/(\..*)\./g, '$1');" > -->
                <table  class="table table-hover small-text" id="tb">
                  ...
                  <tr>
                    ...
                    <td><input type="text" name="fld_taluka_name[]" id="fld_taluka_name" placeholder="Enter Taluka" class="form-control" required="" oninput="this.value = this.value.replace(/[^A-Za-z\s]/g, '').replace(/(\..*)\./g, '$1');" style="text-transform: capitalize;"></td> 
                  </tr>                   
                  </table>
              </div>
            </div>
...
<!--              <label class="col-sm-12 col-md-3 col-form-label">Submit</label>
 -->              <div class="col-sm-12 col-md-9">
              <center><input class="btn btn-success" value="Submit" type="submit" name="submit">
                ...
                <a href="taluka_view.php"><input class="btn btn-warning" value="Back" type="button"></a>
              </center>
              </div>
            </div>
          </form>
